                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="bg-muted p-4 rounded-md font-mono text-sm">
                        <div className="text-muted-foreground mb-2">// Import</div>
                        <div>
                          import {'{'} Input, Label, Checkbox, Switch {'}'} from 'shared-ui'
                        </div>
                        <div className="text-muted-foreground mt-4 mb-2">// Usage</div>
                        <div>
                          {'<'}div className="space-y-2"{'>'}
                    ...
                    <div className="space-y-3">
                      <div className="bg-muted p-4 rounded-md font-mono text-sm">
                        ...
                        <div>
                          ...
                          DialogTitle, DialogDescription {'}'} from 'shared-ui'
                        </div>
                        <div className="text-muted-foreground mt-4 mb-2">// Usage</div>
                        <div>
                          {'<'}Dialog{'>'}
                    ...
                    <div className="space-y-3">
                      <div className="bg-muted p-4 rounded-md">
                        <div className="flex flex-wrap gap-2">
                          ...
                          <Button
                            onClick={() =>
                              toast.info('Thông tin', { description: 'Đây là thông báo thông tin' })
                            }
                            variant="outline"
                          >
                            Info Toast
                          ...
                          <Button
                            onClick={() =>
                              toast.default('Thông báo mặc định', { description: 'Toast mặc định' })
                            }
                            variant="outline"
                          >
                            Default Toast
                      ...
                      <div className="bg-muted p-4 rounded-md font-mono text-sm">
                        ...
                        <div className="text-muted-foreground mt-4 mb-2">
                          // 2. Setup Toaster in your root component (App.tsx or main.tsx)
                        </div>
                        ...
                        <div>{'}'}</div>
                        <div className="text-muted-foreground mt-4 mb-2">
                          // Note: Toaster requires ThemeProvider if using dark mode
                        </div>
                        <div className="text-muted-foreground mt-4 mb-2">
                          // If using next-themes, wrap your app:
                        </div>
                        <div>
            ...
            <TabsContent value="colors" className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Our design system uses CSS variables for theming. All colors support light and
                    dark modes.
                  </CardDescription>
                </CardHeader>
                  ...
                  <div className="space-y-4">
                    {[0.5, 1, 2, 3, 4, 6, 8, 12, 16, 20, 24].map((size) => (
                      <div key={size} className="flex items-center gap-4">
                        <div className="w-20 text-sm text-muted-foreground">{size * 4}px</div>
                        ...
                        <div className="w-24 text-sm font-mono text-muted-foreground">{size}</div>
                      </div>
                    ))}
                  </div>
            ...
            <TabsContent value="components" className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>54+ pre-built components ready to use</CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Import only the components you need. The library is tree-shakeable, so unused
                  components won't be included in your bundle.
                </p>
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  All components accept className props for easy customization. Use Tailwind
                  utilities to extend or override styles.
                </p>
                <div className="bg-muted p-3 rounded-md font-mono text-sm">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Customize the theme by updating CSS variables. All colors support light and dark
                  modes automatically.
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Full TypeScript support with type definitions included. All components are fully
                  typed for better developer experience.
                </p>
              </div>
            </CardContent>
          </Card>
